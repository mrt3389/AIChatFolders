/**
 * SVG icon sprites — inline SVG definitions for the extension UI.
 */
const SVGIcons = {
  folder: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>`,

  folderOpen: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2v1"/><path d="M2 10h20l-2 9H4l-2-9z"/></svg>`,
  ...
  pin: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 17v5"/><path d="M9 2h6l-1 7h4l-5 6H7l5-6H8z"/></svg>`,

  pinFilled: `<svg viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="1"><path d="M12 17v5"/><path d="M9 2h6l-1 7h4l-5 6H7l5-6H8z"/></svg>`,
   ...
   * @param {string} name - icon name from this object
   * @param {number} [size=16] - width/height in pixels
   * @param {string} [className] - optional CSS class
   * @returns {HTMLElement}
   */
  createIcon(name, size = 16, className = '') {
    const svg = this[name];
    if (!svg) {
    ...
    wrapper.className = `acf-icon ${className}`.trim();
